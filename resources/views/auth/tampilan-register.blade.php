...
@section('content')
    <section class="d-flex justify-content-center align-items-center w-100 m-0 p-0">
        <div class="position-relative w-100">
            <img src="{{ asset('assets/img/daftar_magang.png') }}" alt="" class="img-fluid"
                style="height: 50vh; object-fit: cover; z-index: 0;" />
            <img src="{{ asset('assets/img/gambar_magang.png') }}" alt="" class="position-absolute"
                style="top: 50%; left: 80px; transform: translateY(-50%); z-index: 1; width: 250px; height: auto;" />
            <img src="{{ asset('assets/img/gambar_kanan.png') }}" alt="" class="position-absolute"
    ...
    <section class="d-flex justify-content-center align-items-center w-100 m-0 p-0">
        <div class="position-relative w-90">
            <img src="{{ asset('assets/img/daftar_perusahaan.png') }}" alt="" class="img-fluid"
                style="height: 70vh; object-fit: cover; z-index: 0;" />
            <img src="{{ asset('assets/img/Building.png') }}" alt="" class="position-absolute"
