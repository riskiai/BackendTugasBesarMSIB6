                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center"  style="min-width: 150px;">Telphone Perusahaan</th>
                                            ...
                                            <tbody>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="text-center" style="display: flex; align-items: center; gap:10px;">
                                                                                                        ...
                                                                                                        <a href="{{ route('admin.pengguna.edit') }}" class="btn btn-warning" title="Edit">
                                                                                                            <i class="fas fa-edit"></i>
                                                                                                        </a>
                                                                                                        <a href="{{ route('admin.pengguna.create') }}" class="btn btn-success" title="Create">
                                                ...
                                                @endsection
                                                             <tr>
                                                    <td class="text-center">Codepolitan</td>
