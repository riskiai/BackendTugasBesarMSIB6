                                            ...
                                            <div class="card border-0 p-4 text-white" style="background-color: #074173;">
                                                ...
                                                <div class="mt-3 d-flex flex-column align-items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p>TechSolve Solutions, perusahaan teknologi terkemuka di Jakarta,
                                                            mencari Analis Data Junior untuk bergabung dengan timnya.</p>
                                                    </div>
                                                    <a href="{{ url('detail-logowan-kerja-dan-magang') }}"
