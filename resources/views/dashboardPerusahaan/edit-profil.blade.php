                ...
                <div class="col-3 mt-5 p-0 border border-dark border-5 rounded">
                    <div class="bg-primary py-3 text-white">
                        <div class="mx-auto rounded-circle" style="background-color: #d9d9d9; height: 100px; width: 100px">
                            <img class="rounded-circle" src="{{ asset('asset/img/team/team-1.jpg') }}" alt=""
                            ...
                            <form>
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            <label for="hp" class="form-label">Website Perusahaan (Jika ada)</label>
                                            <input type="text" class="form-control" id="hp"
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3">
                                            <label for="address" class="form-label">Perusahaan di Bidang</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="address" class="form-label">Jumlah Karyawan</label>
                                            <input type="text" class="form-control" id="address"
