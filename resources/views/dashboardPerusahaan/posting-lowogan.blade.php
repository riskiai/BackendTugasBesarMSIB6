            ...
            <div>
                <form action="">
                    ...
                    <div class="d-flex align-items-center gap-3 my-3">
                        ...
                        <div class="mb-3">
                            <input class="form-control form-control-sm" id="profilePicture" type="file">
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="Periode" placeholder="Periode Kegiatan">
                    </div>
                    <div class="mb-3">
                        <label for="Jenis" class="form-label">Jenis Pekerjaan</label>
                        <input type="text" class="form-control" id="Jenis" placeholder="Jenis Pekerjaan">
                    </div>
                    <div class="mb-3">
            ...
            <div>
                <form action="">
                    ...
                    <div class="mb-3 mt-5">
                        ...
                        <input type="text" class="form-control" id="judul" placeholder="Judul Pekerjaan">
                    </div>
                    <div class="d-flex align-items-center gap-3 my-3">
                        <img class="rounded-circle" src="{{ asset('assets/img/team/team-1.jpg') }}" alt=""
                            style="height: 100px; width: 100px;">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="text" class="form-control" id="Pekerjaan" placeholder="Jenis Pekerjaan">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
